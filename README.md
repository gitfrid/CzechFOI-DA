...
The py script ending with 'same-scale' uses the same y-axis scale for both age groups. Use this version to compare similar age groups.<br>The file ending with 'different-scale' uses different y-axes with different scales for each age group.
