...
def main():
    ...
    plot_config = PlotConfig(
        ...
        calc_derivate_mean = False      # smooth 1sd and 2nd derivate by moving mean before and after calc
    )
...
def plot_layout(figData, color_palette, plot_config):
    ...
    figData.update_layout(
        ...
        # For different scale add autorange=True for yaxis2-7 and for yaxis8-13
        # For same scale remove autorange=True from yaxis2-7, yaxis8-13 not used then
        # 1st Age_Band (idx)
        ...
        yaxis3=dict(title=plot_config.yaxis3_title, overlaying="y", position=0.9, side="right"),
        yaxis4=dict(title='Cumulative Values y4 VD', overlaying="y", side="right"),
        yaxis5=dict(title='1st and 2nd Derivative y5 DVD', overlaying="y", side="left", position=0.15),  # 1st and 2nd derivative y5
        yaxis6=dict(title='1st and 2nd Derivative y6 VD', overlaying="y", side="left", position=0.25),   # 1st and 2nd derivative y6
        yaxis7=dict(title='Rolling Pearson Correlation y7', overlaying='y', side='right', position=0.8), # Rolling Pearson y7        
